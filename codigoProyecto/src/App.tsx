...
import NuevoUsuarioAdmin from './pages/NuevoUsuarioAdmin';
    ...
    <IonApp>
      <IonReactRouter>
        <IonRouterOutlet>
          ...
          <RoutePrivate exact path="/GestionUsuarios" component={GestionUsuarios} isAdminOnly={true} />
          <RoutePrivate exact path="/NuevoUsuarioAdmin" component={NuevoUsuarioAdmin} isAdminOnly={true} />
          <RoutePrivate exact path="/PerfilUsuario/:id" component={PerfilUsuario} isAdminOnly={true} />
          <RoutePrivate exact path="/editar-usuario/:id" component={EditarUsuario} isAdminOnly={true} />
          <RoutePrivate exact path="/GestionReportes" component={GestionReportes} isAdminOnly={true} />
          {/* DEFAULT */}
          <Route exact path="/">
            <Redirect to="/Login" />
          </Route>
